...
export default function IntermediateCourseDetailPage({ params }: { params: { id: string } }) {
  ...
  const course = {
    ...
    description:
      "Develop advanced business strategy skills including strategic planning, competitive analysis, market positioning, and organizational development. Learn to create comprehensive business plans and strategic initiatives.",
  ...
  const lessons = [
    {
      ...
      description: "Learn the basics of strategic planning and business strategy development.",
      duration: "25 minutes",
      completed: true,
      xp: 25,
    },
    {
      ...
      description: "Understand how to analyze competitors and market positioning.",
      duration: "30 minutes",
      completed: true,
      xp: 30,
    },
    {
      ...
      description: "Learn various market research techniques and data analysis.",
      duration: "35 minutes",
      completed: true,
      xp: 35,
    },
    {
      ...
      description: "Explore different business models and innovation strategies.",
      duration: "40 minutes",
      completed: true,
      xp: 40,
    },
    ...
    },
    {
      ...
      description: "Learn how to implement strategic plans and measure success.",
      duration: "45 minutes",
      completed: false,
      xp: 45,
    },
                ...
                {lessons.map((lesson) => (
                  <Card key={lesson.id} className="duo-card overflow-hidden">
                    <CardContent className="p-0">
                      <Link
                        href={`/courses/intermediate/${course.id}/lessons/${lesson.id}`}
                  ...
                  <ul className="space-y-3">
                    <li>
                      <div className="flex items-center text-muted-foreground cursor-not-allowed">
                        ...
                        Strategic Planning Templates (Coming Soon)
                      </div>
                    </li>
                    <li>
                      <div className="flex items-center text-muted-foreground cursor-not-allowed">
                        <BookOpen className="h-4 w-4 mr-2" />
                        Market Analysis Framework PDF (Coming Soon)
                      </div>
                    </li>
                    <li>
                      <div className="flex items-center text-muted-foreground cursor-not-allowed">
                        <BookOpen className="h-4 w-4 mr-2" />
                        Business Strategy Case Studies (Coming Soon)
                      </div>
                    </li>
                  </ul>
                </CardContent>
          ...
          <Card className="duo-card">
            <CardContent className="p-4 space-y-4">
              ...
              <Button className="w-full duo-button bg-primary text-white" asChild>
                <Link href={`/courses/intermediate/${course.id}/lessons/5`}>Continue Learning</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="duo-card bg-gradient-to-r from-primary/10 to-secondary/10">
            <CardContent className="p-4 flex flex-col items-center text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Apply strategic concepts to real business scenarios. Practice with case studies and role-playing
